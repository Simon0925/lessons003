...
//task 2
function userInfo (){
    console.log(this.registered === true? `Дата регистрации:${this.data.toLocaleDateString()}`:`Незарегистрированный пользователь:${name}` )

}
var user= {
    name :" Mark " ,
    registered :true,
    data : new Date(2017, 8, 7),
    getInfo: userInfo
}
var user1 = {
    name :" Petro " ,
...
var users = {
  ...
  console.log("3. Автор + комментарий")
